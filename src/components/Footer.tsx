      ...
      <div className="footer-inner">
            ...
            <ul className="footer-col-links">
              <li>
                <a
                  ...
                  onClick={(e) => handleNavigate(e, 'terms-of-service')}
                >
                  Terms of Service
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  className="footer-link-item"
                  onClick={(e) => handleNavigate(e, 'refund-policy')}
                >
                  Refund Policy
                </a>
              </li>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-meta">
            <p className="footer-copy">© {new Date().getFullYear()} JobHunter. Pre-launch.</p>

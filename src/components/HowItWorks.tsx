...
const steps = [
  ...
  },
  {
    ...
    desc: (
      <>
        For each selected job, the AI analyses the description against your resume and produces a tailored variant and cover letter. It curates — never fabricates.{' '}
        <a href="/features" style={{ color: 'var(--accent)', textDecoration: 'underline' }}>
          Learn how AI resume optimization works
        </a>.
      </>
    ),
    icon: (
